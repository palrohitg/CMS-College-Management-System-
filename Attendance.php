 ...
 <?php 
       if(!isset($_REQUEST['Submit']))
       {
      	?>
            ...
            <form class='form-group' action='Attendance.php' method='Post'>
             ...
             echo "		
                   ...
                   <tr> 
                         ...
                         <td> $Name</td> 
                          ...
                          <td> <input type='checkbox' name='8a'   value='1'></td> 
